...
layout: examples
title: PhonePack
permalink: /demos/switch/index/
---


<header class="header header--shadow bg-white text-black">
      <div class="header__title">Checkbox</div>
</header>
...
<section class="content content--padding has-header">
        ...
        <div class="switch">
            ...
            <span class="switch__help">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed posuere faucibus efficitur.</span>
        </div>
        ...
        <div class="switch">
            ...
            <label for="switch4" class="switch__label">Switch checked and disabled</label>
            <span class="switch__help">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed posuere faucibus efficitur.</span>
        </div>
</section> 
